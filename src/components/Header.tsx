    ...
    <header className="fixed top-0 w-full z-50 backdrop-blur-md border-b border-gray-900">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        <a href="#" className="mono text-xl font-bold tracking-tighter">
          <span className="text-blue-600">Cody</span>Tech<span className="text-blue-600">_</span>
        </a>
        <nav className="flex items-center gap-4 md:gap-8">
          <div className="mono text-xs space-x-8 hidden md:flex">
            <a href="#services" className="text-gray-400 hover:text-blue-400 transition-colors uppercase tracking-widest">
              {t.nav.services}
            </a>
            <a href="#portfolio" className="text-gray-400 hover:text-blue-400 transition-colors uppercase tracking-widest">
              {t.nav.portfolio}
            </a>
            <a href="#contact" className="text-gray-400 hover:text-blue-400 transition-colors uppercase tracking-widest">
              {t.nav.contact}
            </a>
          </div>
